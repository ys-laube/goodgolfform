      ...
      holes: [
        {
          ...
          par: 5,
          backdoorOpen: true,
          nearPlayerId: 'player-2',
          scores: [
            { playerId: 'player-1', strokes: 4, entryMode: 'on-putt' as const, onGreenShots: 2, putts: 2, holeInOne: false },
            { playerId: 'player-2', strokes: 5, entryMode: 'manual' as const },
            { playerId: 'player-3', strokes: 4, entryMode: 'manual' as const },
            { playerId: 'player-4', strokes: 6, entryMode: 'manual' as const },
          ],
        },
      ],
    };
